#RPi4 DALI Controller Application Interface
#DALI Interface Module to C DALI application
import tkinter as tk
from tkinter import *
from tkinter import ttk
import ctypes
_C_DALI_func = ctypes.CDLL('/home/pi/DALI_int/libdali.so')
...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master = master
        self.master.title("RPi4 DALI Controller Application Interface")
        self.pack()
